...
function Section({
  ...
  return (
    <section className="mb-10">
      <h2 className="text-lg font-bold text-gray-700 border-b border-gray-200 pb-2 mb-4">
        {title}
      </h2>
  ...
  return (
    ...
    >
      <Layout maxWidth="960px" styleClass={{ root: 'mx-auto px-6' }}>
        <Layout.Header
          styleClass={{ root: 'py-6 border-b border-gray-200 mb-8' }}
        >
          <h1 className="text-2xl font-bold text-gray-900">
            imnotpizza-libs Component Showcase
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            라이브러리에 포함된 모든 컴포넌트 미리보기
          </p>
        </Layout.Header>
        ...
        <Layout.Body styleClass={{ root: 'py-8' }}>
          ...
          <Section title="Button">
            <Button
              styleClass={{
                root: 'bg-gray-900 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-700 transition-colors',
              }}
            >
              기본 버튼
            </Button>
            <Button
              styleClass={{
                root: 'border border-gray-900 text-gray-900 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-50 transition-colors',
              }}
            >
              아웃라인 버튼
            </Button>
            <Button
              styleClass={{
                root: 'bg-gray-100 text-gray-400 px-4 py-2 rounded-md text-sm font-medium cursor-not-allowed',
              }}
              disabled
            >
              비활성 버튼
            ...
            <Button
              styleClass={{
                root: 'bg-red-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-red-600 transition-colors',
              }}
            >
              위험 버튼
            </Button>
          ...
          <Section title="Card">
            <Card className="w-72 h-48">
              ...
              <Card.Body>
                <p className="text-sm text-gray-600">
                  카드 본문 내용이 들어가는 영역입니다. 다양한 콘텐츠를 배치할
                  수 있습니다.
                </p>
              </Card.Body>
            </Card>
            <Card className="w-72 h-48">
              <Card.Header>
                ...
                <Button
                  styleClass={{ root: 'text-xs text-blue-500 hover:underline' }}
                >
                  더보기
                </Button>
              </Card.Header>
          ...
          <Section title="Skeleton">
            <Skeleton.Container
              styleClass={{ root: 'flex flex-col gap-3 w-64' }}
            >
              <div className="flex items-center gap-3">
                <Skeleton.Circle
                  styleClass={{
                    root: 'w-10 h-10 rounded-full bg-gray-200 animate-pulse shrink-0',
                  }}
                />
                <div className="flex flex-col gap-2 flex-1">
                  <Skeleton.Box
                    styleClass={{
                      root: 'w-full h-3 rounded bg-gray-200 animate-pulse',
                    }}
                  />
                  <Skeleton.Box
                    styleClass={{
                      root: 'w-3/4 h-3 rounded bg-gray-200 animate-pulse',
                    }}
                  />
                </div>
              </div>
              <Skeleton.Box
                styleClass={{
                  root: 'w-full h-24 rounded-lg bg-gray-200 animate-pulse',
                }}
              />
              <Skeleton.Box
                styleClass={{
              ...
              <Skeleton.Box
                styleClass={{
                  root: 'w-2/3 h-3 rounded bg-gray-200 animate-pulse',
                }}
              />
            </Skeleton.Container>
          </Section>
          ...
          <Section title="Tab">
            <Tab.Root defaultValue="tab1" className="w-full max-w-md">
              ...
              <Tab.Content
                value="tab1"
                styleClass={{ root: 'pt-4 text-sm text-gray-600' }}
              >
                첫 번째 탭의 콘텐츠입니다.
              </Tab.Content>
              <Tab.Content
          ...
          <Section title="Selectbox">
            <Selectbox
              ...
              styleClass={{
                trigger:
                  'border border-gray-300 rounded-md px-3 py-2 text-sm w-40 flex justify-between items-center hover:bg-gray-50',
                content:
          ...
          <Section title="Popover">
            <Popover.Root>
              <Popover.Trigger asChild>
                <Button
                  styleClass={{
                    root: 'border border-gray-300 rounded-md px-4 py-2 text-sm hover:bg-gray-50 transition-colors',
                  }}
                >
                  팝오버 열기
                </Button>
              ...
              >
                ...
                <p className="text-xs text-gray-500 mb-3">
                  팝오버 안에 자유롭게 콘텐츠를 배치할 수 있습니다.
                </p>
                <Popover.Close asChild>
                  <Button
                    styleClass={{
                      root: 'text-xs text-gray-500 hover:text-gray-900',
                    }}
                  >
                    닫기
                  </Button>
          ...
          <Section title="Anim">
            <div className="w-full flex flex-col gap-6">
              ...
              <div>
                <p className="text-xs text-gray-500 mb-2">
                  Anim.Fade (direction: left, delay: 200ms)
                </p>
        ...
        <Layout.Footer
          styleClass={{
            root: 'border-t border-gray-200 py-6 text-center text-xs text-gray-400',
          }}
        >
          imnotpizza-libs · Component Showcase
        </Layout.Footer>
